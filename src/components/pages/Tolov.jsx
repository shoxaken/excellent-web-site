...
function TolovTwo() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        `https://excellentlc.uz/tolovapi/?q=${inputWord}`
      );
  ...
  return (
    <div className="container2">
      ...
      /><br/>
      <Typography.Link href='https://excellentlc.uz/admin/myfiles/tolov10_15/' target='_blank'>To'lov qilganlarni qo'shish</Typography.Link>
