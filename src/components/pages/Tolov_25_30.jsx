...
function Tolov_25_30() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        `https://excellentlc.uz/tolov25_30api/?q=${inputWord}`
      );
  ...
  return (
    <div className="container2">
      ...
      /><br/>
      <Typography.Link href='https://excellentlc.uz/admin/myfiles/tolov25_30/' target='_blank'>To'lov qilganlarni qo'shish</Typography.Link>
      <h2>Paid Items</h2>
      <ul>
        {filteredData
